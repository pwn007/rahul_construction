  ...
  return (
    <>
      <Seo
        ...
        description="Vastu resolved at concept stage, not patched afterwards. Direction-wise placement of entrance, kitchen, master bedroom and services designed into the plan itself."
      />
