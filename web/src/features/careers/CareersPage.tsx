  ...
  return (
    <>
      <Seo
        ...
        description="Join a small team where architects, engineers and site staff work together. Open roles in design, engineering and site execution in Jaipur."
      />
