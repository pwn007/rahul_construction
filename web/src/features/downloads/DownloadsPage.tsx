  ...
  return (
    <>
      <Seo
        ...
        description="Download the Neetu Archstone company profile, turnkey brochure, 2026 rate card, MEPF capability statement, pre-construction checklist and Vastu guide."
      />
