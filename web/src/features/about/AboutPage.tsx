  ...
  return (
    <>
      <Seo
        ...
        description="Neetu Archstone combines architecture, engineering and execution into one accountable system. Meet the team behind 80+ delivered projects in Jaipur."
      />
