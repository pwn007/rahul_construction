          ...
          <div className={cn(hasAside ? 'lg:col-span-6 lg:pt-4' : 'max-w-3xl')}>
            {breadcrumbs && (
              <Reveal>
                ...
                >
                  <Link to={ROUTES.home} className="inline-block py-1.5 transition-colors hover:text-cyan-700 dark:hover:text-cyan-400">
                    Home
                  </Link>
                  {breadcrumbs.map((b) => (
                    <span key={b.label} className="flex items-center gap-2">
                      ...
                      {b.href ? (
                        <Link to={b.href} className="inline-block py-1.5 transition-colors hover:text-cyan-700 dark:hover:text-cyan-400">
                          {b.label}
                        </Link>
                      ) : (
