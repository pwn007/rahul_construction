...
export const enquiries: Enquiry[] = [
  ...
  { ...meta('enq_2', day(0)), name: 'Meenakshi Rathore', phone: '+91 99285 44551', email: 'meenakshi.r@example.com', serviceInterest: 'Interior Design', city: 'Jaipur', budget: '₹20 – 30 L', message: '3 BHK apartment in Mansarovar, possession next month. Need full interiors.', source: 'service-page', stage: 'new' },
  { ...meta('enq_3', day(1)), name: 'Deepak Agarwal', phone: '+91 94140 77812', serviceInterest: 'MEPF Consultancy', city: 'Jaipur', budget: 'Not sure', message: 'Building a 3-floor commercial complex on Tonk Road, need MEPF design only.', source: 'project-page', stage: 'contacted' },
  ...
  { ...meta('enq_8', day(7)), name: 'Mohit Saini', phone: '+91 96020 74413', serviceInterest: 'Project Management', city: 'Jaipur', message: 'Already have a contractor, want independent supervision and reporting.', source: 'service-page', stage: 'contacted' },
];

export const estimateRequests: EstimateRequest[] = [
  { ...meta('est_1', day(0)), name: 'Ritu Sharma', phone: '+91 98871 20034', email: 'ritu.sharma@example.com', propertyType: 'residential', plotArea: 1500, areaUnit: 'sqft', floors: 2, packageType: 'semi-furnished', qualityTier: 'signature', location: 'mansarovar', enhancements: ['modular-kitchen', 'false-ceiling'], builtUpArea: 2160, totalMin: 4243000, totalMax: 4874000, timelineWeeks: 36, stage: 'qualified' },
  { ...meta('est_2', day(1)), name: 'Karan Vyas', phone: '+91 93520 88104', propertyType: 'residential', plotArea: 2400, areaUnit: 'sqft', floors: 3, packageType: 'fully-furnished', qualityTier: 'bespoke', location: 'c-scheme', enhancements: ['modular-kitchen', 'wardrobes', 'home-automation', 'lift'], builtUpArea: 5184, totalMin: 18420000, totalMax: 21160000, timelineWeeks: 58, stage: 'converted' },
  { ...meta('est_3', day(2)), name: 'Aakash Gupta', phone: '+91 89550 33210', email: 'aakash.g@example.com', propertyType: 'commercial', plotArea: 3000, areaUnit: 'sqft', floors: 3, packageType: 'civil', qualityTier: 'essential', location: 'sanganer', enhancements: ['waterproofing', 'elevation'], builtUpArea: 6480, totalMin: 8104000, totalMax: 9310000, timelineWeeks: 48, stage: 'contacted' },
  { ...meta('est_4', day(3)), name: 'Nisha Bhargava', phone: '+91 91166 45520', propertyType: 'interior-only', plotArea: 1800, areaUnit: 'sqft', floors: 1, packageType: 'fully-furnished', qualityTier: 'signature', location: 'vaishali-nagar', enhancements: ['modular-kitchen', 'wardrobes', 'false-ceiling'], builtUpArea: 1800, totalMin: 5920000, totalMax: 6800000, timelineWeeks: 18, stage: 'new' },
  { ...meta('est_5', day(4)), name: 'Suresh Yadav', phone: '+91 94610 20087', propertyType: 'residential', plotArea: 200, areaUnit: 'sqyd', floors: 2, packageType: 'civil', qualityTier: 'essential', location: 'jhotwara', enhancements: ['boundary-wall'], builtUpArea: 2592, totalMin: 3208000, totalMax: 3686000, timelineWeeks: 32, stage: 'new' },
  { ...meta('est_6', day(5)), name: 'Farida Khan', phone: '+91 90790 11556', email: 'farida.k@example.com', propertyType: 'mixed-use', plotArea: 2600, areaUnit: 'sqft', floors: 3, packageType: 'semi-furnished', qualityTier: 'signature', location: 'malviya-nagar', enhancements: ['elevation', 'waterproofing', 'lift'], builtUpArea: 5616, totalMin: 12440000, totalMax: 14290000, timelineWeeks: 52, stage: 'contacted' },
];
...
export const footerColumns: FooterColumn[] = [
  ...
  { ...meta('fc_3', '2026-01-01T09:00:00.000Z'), heading: 'Resources', order: 3, links: [ { label: 'Cost Estimator', href: '/estimator' }, { label: 'Pricing & Packages', href: '/pricing' }, { label: 'Gallery', href: '/gallery' }, { label: 'Downloads', href: '/downloads' }, { label: 'Client Portal', href: '/portal' } ] },
];
