...
return [
    ...
    */
    ...
    /* One working day, not the package's 60 minutes. There is no refresh
       machinery in this phase, so the TTL alone decides how often the admin is
       thrown back to the login screen; hourly would make the panel unusable on
       site visits. Revocation still works — logout blacklists the token. */
