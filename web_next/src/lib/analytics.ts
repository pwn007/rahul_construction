 ...
 *
 * With `NEXT_PUBLIC_GTM_ID` unset the whole module is inert: `load()` returns without
 ...
 * id stays configuration: a build without `NEXT_PUBLIC_GTM_ID` ships no third-party
