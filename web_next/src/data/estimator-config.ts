...
export const ESTIMATOR_PRICES: EstimatorPrice[] = [
  ...
  { ...meta('esp_30'), key: 'doors:flush', label: 'Doors — Flush shutter (Commercial grade)', unit: 'per door', rate: 9800, image: '/images/materials/doors-flush.jpg', order: 30 },
  { ...meta('esp_31'), key: 'doors:laminated', label: 'Doors — Laminated shutter (Laminate both faces)', unit: 'per door', rate: 12000, image: '/images/materials/doors-laminated.jpg', order: 31 },
