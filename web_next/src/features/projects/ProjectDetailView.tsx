    ...
    <>
          ...
          <div className="container absolute inset-x-0 bottom-0 pb-12">
            <Reveal>
              <nav aria-label="Breadcrumb" className="mb-5 flex items-center gap-2 text-caption text-white/50">
                <Link href={ROUTES.home} className="hover:text-cyan-400">
                  Home
                </Link>
                <span>/</span>
                <Link href={ROUTES.projects} className="hover:text-cyan-400">
                  Projects
                </Link>
                <span>/</span>
      ...
      <section className="border-y">
        <div className="container grid divide-y md:grid-cols-2 md:divide-x md:divide-y-0">
          {prev && (
            <Link href={ROUTES.project(prev.slug)} className="group flex items-center gap-4 py-8 pr-6 md:py-10">
          ...
          {next && (
            <Link href={ROUTES.project(next.slug)} className="group flex items-center justify-end gap-4 py-8 text-right md:py-10 md:pl-6">
              <div>
