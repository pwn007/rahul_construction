      ...
      */}
      {oldestNewLeadHours !== null && oldestNewLeadHours > 1 && (
        <Reveal>
          ...
          >
            ...
            <Link href="/admin/enquiries" className="underline underline-offset-2">
              Open the queue
            </Link>
          </div>
        </Reveal>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <Reveal delay={0.16} className="lg:col-span-5">
          <ChartCard title="Recent enquiries" subtitle="Newest first" action={<Link href="/admin/enquiries" className="flex items-center gap-1 text-caption text-cyan-700 dark:text-cyan-400">View all <ArrowUpRight className="h-3 w-3" /></Link>}>
