      ...
      <article>
        <header className="pt-32 md:pt-40">
          <div className="container max-w-4xl">
            <Link href={ROUTES.blog} className="inline-flex items-center gap-2 py-1.5 text-caption text-subtle transition-colors hover:text-cyan-700">
        ...
        <section className="section-sm border-t">
          <div className="container">
            ...
            <div className="mt-10 grid gap-8 md:grid-cols-3">
              {related.map((p) => (
                <Link key={p.id} href={ROUTES.post(p.slug)} className="group block">
