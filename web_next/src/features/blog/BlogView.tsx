  ...
  return (
    <>
      <PageHero
        ...
        aside={
          featured ? (
            <Link href={ROUTES.post(featured.slug)} className="group block">
      ...
      {featured && (
        <section className="section-sm pb-0">
          <div className="container">
            <Link href={ROUTES.post(featured.slug)} className="group grid gap-8 lg:grid-cols-12 lg:items-center">
